...
import { ObjectID, ObjectId, ObjectIdLike } from "bson";
...
import { List, default as Realm_2, Results } from "realm";
...
declare class CacheService {
  ...
  private readonly _logService;
  constructor(
    _cacheDatabaseCore: CacheDatabaseCore,
  ...
  ): Promise<Results<IPaperEntityObject>>;
  /**
...
declare class CategorizerRepository extends Eventable<ICategorizerRepositoryState> {
  ...
  ): ICategorizerRealmObject | (Categorizer & Realm_2.Object<unknown, never>);
  /**
...
declare class CategorizerService extends Eventable<ICategorizerServiceState> {
  ...
  constructor(
    ...
    _categorizerRepository: CategorizerRepository,
    _logService: LogService,
    _preferenceService: PreferenceService
  );
  /**
  ...
  create(
    ...
    ICategorizerRealmObject | (Categorizer & Realm.Object<unknown, never>)
  >;
  /**
...
declare class ExtensionManagementService extends Eventable<IExtensionManagementServiceState> {
  ...
  constructor(
    _extensionPreferenceService: ExtensionPreferenceService,
...
declare class FeedEntityRepository extends Eventable<IFeedEntityRepositoryState> {
  ...
  toRealmObject(
    realm: Realm_2,
    feedEntity: IFeedEntityObject
  ): IFeedEntityRealmObject | undefined;
  /**
  ...
  ): (FeedEntity & Realm_2.Object<unknown, never>) | IFeedEntityRealmObject;
  /**
...
declare class FeedRepository extends Eventable<IFeedRepositoryState> {
  ...
  update(
    ...
    feed: IFeedObject,
    partition: string
  ): (Feed & Realm_2.Object<unknown, never>) | IFeedRealmObject;
...
declare class FeedService extends Eventable<IFeedServiceState> {
  ...
  constructor(
    _databaseCore: DatabaseCore,
    _feedEntityRepository: FeedEntityRepository,
  ...
  updateEntities(
    feedEntities: IFeedEntityCollection,
    ignoreReadState?: boolean
  ): Promise<IFeedEntityObject[] | undefined>;
  /**
   * Create feeds.
   * @param feeds - Feeds
   */
...
declare class HookService {
   ...
   */
  transformhookPoint<T extends any[], O extends any[]>(
    hookName: string,
    timeout: number,
    ...args: T
  ): Promise<any[]>;
...
declare type ICategorizerCollection =
...
declare type ICategorizerRealmObject = Categorizer &
  Realm_2.Object<Categorizer, "_id" | "name" | "color" | "children">;
...
declare type IFeedEntityCollection =
...
declare type IFeedEntityRealmObject = FeedEntity &
  Realm_2.Object<
    FeedEntity,
    | "_id"
    | "addTime"
...
declare type IFeedRealmObject = Feed &
  Realm_2.Object<Feed, "_id" | "name" | "count" | "url">;
...
declare type IPaperEntityCollection =
...
declare type IPaperEntityRealmObject = PaperEntity &
  Realm_2.Object<
    PaperEntity,
    | "_id"
    | "title"
...
declare type IPaperSmartFilterCollection =
...
declare type IPaperSmartFilterObject =
  | PaperSmartFilter
  | IPaperSmartFilterRealmObject;

declare type IPaperSmartFilterRealmObject = PaperSmartFilter &
  Realm_2.Object<
    PaperSmartFilter,
...
declare class MenuService extends Eventable<IMenuServiceState> {
  ...
  onClick: (
    key: keyof IMenuServiceState | (keyof IMenuServiceState)[],
    callback: (newValues: { key: keyof IMenuServiceState; value: any }) => void
  ) => () => void;
  /**
...
declare class PaperEntityRepository extends Eventable<IPaperEntityRepositoryState> {
  ...
  ): IPaperEntityRealmObject | undefined;
  /**
  ...
  load(
    ...
    sortBy: string,
    sortOrder: "asce" | "desc"
  ): Realm_2.Results<PaperEntity & Realm_2.Object<unknown, never>>;
  /**
  ...
  delete(
    realm: Realm_2,
    ids?: OID[],
    paperEntitys?: IPaperEntityCollection
  ): string[];
}
...
declare class PaperService extends Eventable<IPaperServiceState> {
  ...
  constructor(
    _databaseCore: DatabaseCore,
    _paperEntityRepository: PaperEntityRepository,
    _scrapeService: ScrapeService,
  ...
  loadByIds(
    ...
    never[] | Realm.Results<PaperEntity & Realm.Object<unknown, never>>
  >;
  /**
...
declare class PaperSmartFilterRepository extends Eventable<ISmartFilterServiceState> {
  ...
  toRealmObject(
    realm: Realm_2,
    paperSmartFilter: IPaperSmartFilterObject
  ): IPaperSmartFilterRealmObject | null;
  /**
   *
   * @param realm - Realm instance
  ...
  load(
    ...
    sortBy: string,
    sortOrder: string
  ): Realm_2.Results<PaperSmartFilter & Realm_2.Object>;
  /**
  ...
  update(
    ...
    | (PaperSmartFilter & Realm_2.Object<unknown, never>)
    | IPaperSmartFilterRealmObject;
  /**
   * Recursively update children name.
   */
...
export declare abstract class PLExtension {
  ...
  checkPreference(preference: { [key: string]: any }): void;
}
...
declare class RenderService {
   ...
   */
  renderPDFCache(
    cachedThumbnail: ThumbnailCache,
    canvasId: string
  ): Promise<void>;
  /**
...
declare class SmartFilterService extends Eventable<ISmartFilterServiceState> {
  ...
  constructor(
    _databaseCore: DatabaseCore,
    _paperSmartFilterRepository: PaperSmartFilterRepository,
    _logService: LogService
  );
  /**
   * Load smartfilters.
  ...
  update(
    ...
    | (PaperSmartFilter & Realm.Object<unknown, never>)
    | IPaperSmartFilterRealmObject
  >;
  /**
   * Migrate the local database to the cloud database. */
